...
mod tests {
    ...
    fn split_sql_statements_mysql_insert_values() {
        let sql = "INSERT INTO t (id, name) VALUES (1, 'a'); INSERT INTO t (id, name) VALUES (2, 'b')";
    ...
    fn first_sql_keyword_returns_uppercase() {
        ...
        assert_eq!(first_sql_keyword("INSERT INTO t"), Some("INSERT".to_string()));
    }
    ...
    fn first_sql_keyword_skips_line_comment() {
        assert_eq!(first_sql_keyword("-- comment\nSELECT 1"), Some("SELECT".to_string()));
    }

    #[test]
    fn first_sql_keyword_skips_block_comment() {
        assert_eq!(first_sql_keyword("/* comment */ SELECT 1"), Some("SELECT".to_string()));
    }
