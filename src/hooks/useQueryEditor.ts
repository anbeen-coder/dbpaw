...
export function useQueryEditor({
  ...
  return {
    ...
    handleExecuteQuery,
    handleCancelQuery,
    pendingRiskConfirmation: sqlExecution.pendingRiskConfirmation,
    confirmRiskExecution: sqlExecution.confirmRiskExecution,
    cancelRiskExecution: sqlExecution.cancelRiskExecution,
